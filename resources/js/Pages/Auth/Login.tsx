                        ...
                        <div className="mb-5 p-3 rounded-2xl bg-slate-50 border border-slate-100 space-y-1.5">
                            ...
                            <div className="grid grid-cols-3 gap-1.5">
                                ...
                                <button
                                    ...
                                    className="px-2 py-1.5 rounded-lg bg-white border border-slate-200 hover:border-emerald-300 hover:bg-emerald-50/50 text-[11px] font-bold text-slate-700 transition flex flex-col items-center gap-0.5"
                                >
